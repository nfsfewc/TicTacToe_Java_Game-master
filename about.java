...
public class about extends javax.swing.JFrame {
    ...
    .put(javax.swing.KeyStroke.getKeyStroke("ESCAPE"), "exitToStart");

getRootPane().getActionMap().put("exitToStart", new javax.swing.AbstractAction() {
    @Override
    public void actionPerformed(java.awt.event.ActionEvent e) {
        new Start().setVisible(true);
        dispose(); // تقفل صفحة Help
    }
});
    ...
    private void initComponents() {
        ...
        jButton1.setText("REURN TO MENU");
